...
number_steps_receiver = 8500 #5000
number_steps_channel = 8500 #5000
number_steps_transmitter = 7500 #8500 #5000
# display_step = 100
batch_size = 320
...
with tf.Session(config=config) as sess:
    ...
    for iteration in range(number_iterations):
        # number_steps_transmitter += 100 #2000  # 5000
        # number_steps_receiver += 100 #2000  # 5000
        # number_steps_channel += 50 #1000  # 2000
